...
import { ComputedServerConfig, HealthAnnotationType, RateHealthConfig, RegexConfig, ResponseDetail, Responses, ToleranceConfig } from '@backstage-community/plugin-kiali-common';
