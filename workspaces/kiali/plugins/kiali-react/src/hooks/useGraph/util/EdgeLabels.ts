...
import { EdgeData, GraphPFSettings, NodeData, NodeMap } from '../types/';
import { ComputedServerConfig, EdgeLabelMode,numLabels,
    Protocol,
    Responses,
    ToleranceConfig,
    TrafficRate, } from '@backstage-community/plugin-kiali-common';
import { RateHealth } from '../../../types/HealthAnnotation';
import { aggregate } from '../../../types/ErrorRate/ErrorRate';
  ...
  export const getEdgeHealth = (
    ...
    const configSource =
      annotationSource && annotationSource.toleranceConfig
        ...
        : getRateHealthConfig(source.namespace, source.nodeType, source.nodeType, config)
            .tolerance;
    ...
    const configTarget =
      annotationTarget && annotationTarget.toleranceConfig
        ...
        : getRateHealthConfig(target.namespace, target.nodeType, target.nodeType, config)
            .tolerance;
