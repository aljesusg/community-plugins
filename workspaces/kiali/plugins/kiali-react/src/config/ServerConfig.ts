...
export function getHomeCluster(cfg: ServerConfig): MeshCluster | undefined {
...
export function isMC(config: ServerConfig): boolean {
  return Object.keys(config.clusters).length > 1;
}
