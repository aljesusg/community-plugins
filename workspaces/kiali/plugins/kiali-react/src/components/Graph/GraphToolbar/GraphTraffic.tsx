...
import { isAmbientRate } from '../../../types/Graph';
...
import { ComputedServerConfig, TrafficRate, isGrpcRate, isHttpRate, isTcpRate } from '@backstage-community/plugin-kiali-common';
import { style } from 'typestyle';
import { KialiIcon } from '../../../config';
import { KialiConfig } from '../../../hooks';


const infoStyle= style({ marginLeft: '0.375rem' });
...
export const GraphTraffic: React.FC<GraphTrafficProps> = (props: GraphTrafficProps) => {
    ...
    const trafficRateOptions: TrafficRateOptionType[] = [
      {
        ...
        isHidden: !config.ambientEnabled,
        tooltip: (
