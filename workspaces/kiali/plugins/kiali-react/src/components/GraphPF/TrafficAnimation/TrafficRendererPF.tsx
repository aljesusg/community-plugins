...
import { ComputedServerConfig, Protocol } from '@backstage-community/plugin-kiali-common';
...
export class TrafficAnimation {
   ...
   */
  start(serverConfig: ComputedServerConfig) {
   ...
   * Stops the animation
   */
  stop(serverConfig: ComputedServerConfig) {
    const settings = serverConfig.kialiFeatureFlags.uiDefaults.graph.settings;
    const edges = this.controller.getGraph().getEdges();
