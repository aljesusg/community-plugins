  ...
  React.useEffect(() => {
    ...
    const generateDataModel = (): { edges: EdgeModel[]; nodes: NodeModel[] } => {
      ...
      function addGroup(data: NodeData): NodeModel {
        ...
        setNodeLabel(group, nodeMap, graphSettings, layoutName, config);
      ...
      function addNode(data: NodeData): NodeModel {
        ...
        setNodeLabel(node, nodeMap, graphSettings, layoutName, config);
      ...
      assignEdgeHealth(graphData.elements.edges || [], nodeMap, graphSettings, config);
